		...
		elseif(empty($trms)){
			...
			if(mysqli_num_rows($checkEmailSQLResult)==0){
				...
				if($registerSQLResult){
					$subject= "Dashboard Registration Mail";
					$hTMLbody= "
					<p><strong>$name</strong> Register Successfully</p>
					<button><a target='_blank' href=".$_SERVER['HTTP_HOST']."/login.php>Click to login</a></button>
					";
